...
from src.predictor.scikit import SvrClassifier, SvrRegressor, RandomForestClassifier, RandomForestRegressor, PredictorBase
...
def train(
    ...
    if hasattr(predictor, 'inject_featurizer'):
        ...
        logging.info(f"Injecting {featurizer.name()} featurizer into {predictor.name()}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, help="Path to the config file", default="configs/train_clf.gin")
